        ...
        <form class="form form-horizontal" action="user/login" method="post">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8">
                    用户名：<input id="username" name="username" type="text" placeholder="账户" class="input-text size-L">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">         </i></label>
                <div class="formControls col-xs-8">
                    密码：<input id="password" name="password" type="password" placeholder="密码" class="input-text size-L">
                </div>
            </div>
