...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="<%=request.getContextPath()%>/WEB-INF/admin-jsp/welcome.jsp">我的桌面</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="<%=request.getContextPath()%>/WEB-INF/admin-jsp/welcome.jsp"></iframe>
        </div>
    </div>
</section>
...
<script type="text/java-
 ...
 s+
 cript" src="lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
